...
function AddBooks() {
    ...
    const register = async (event) => {
        ...
        if (!bookTitle || !author || !category || !description || !quantity || !publishedDate || !imageUrl) {
            toast.error('Fill out all fields.');
            return;
        }
            ...
            <div className="main">
                ...
                <div id="addForm">
                    ...
                    <form>
                        ...
                        <input type="text" id="imageUrl" name="imageUrl" onChange={(e) => setImageUrl(e.target.value)} autoComplete="off" required value={imageUrl} />

                        <label htmlFor="bookpublished">Book Published:</label>
                        <input type="date" id="bookpublished" name="bookpublished" onChange={(e) => { setpublishedDate(e.target.value) }} autoComplete="off" required value={publishedDate} />
